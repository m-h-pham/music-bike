...
int main()
{
    ...
    result = system->createSound("C:\\dev\\C++\\FMODSetup\\sounds\\drumloop.wav", FMOD_DEFAULT, nullptr, &drumloop);
    checkError(result);

    result = system->createSound("C:\\dev\\C++\\FMODSetup\\sounds\\jaguar.wav", FMOD_DEFAULT, nullptr, &jaguar);
    checkError(result);

    result = system->createSound("C:\\dev\\C++\\FMODSetup\\sounds\\swish.wav", FMOD_DEFAULT, nullptr, &swish);
    checkError(result);

    result = system->createSound("C:\\dev\\C++\\FMODSetup\\sounds\\imperial_march.wav", FMOD_DEFAULT, nullptr, &swish);
    checkError(result);
